...
import io.github.fiifoo.scarl.core.{Assets, Rng, State}
...
object FormatState {
  ...
  implicit val formatReceivedCommunications = formatMap(formatCreatureId, implicitly[Format[Set[CommunicationId]]])
