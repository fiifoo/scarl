...
import io.github.fiifoo.scarl.core.entity.Selectors.{getCreatureHostileFactions, getLocationWaypoint}
...
object ShootMissileOutcomeSimulation {
  ...
  def apply(instance: State, shooter: CreatureId, location: Location, missile: CreatureKindId): Outcome = {
    val enemies = getCreatureHostileFactions(instance)(shooter)
